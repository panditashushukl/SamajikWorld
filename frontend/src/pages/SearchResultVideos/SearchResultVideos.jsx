                                ...
                                <div className="flex gap-x-2 md:w-7/12">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="mt-2 hidden text-sm md:block">
                                            ...
                                            including variables, data types, and
                            ...
                            <div className="w-full max-w-3xl gap-x-4 md:flex">
                                ...
                                <div className="flex gap-x-2 md:w-7/12">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="mt-2 hidden text-sm md:block">
                                            Discover how to build mobile
                                            applications using React Native for
                            ...
                            <div className="w-full max-w-3xl gap-x-4 md:flex">
                                ...
                                <div className="flex gap-x-2 md:w-7/12">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="mt-2 hidden text-sm md:block">
                                            Learn how to create and use custom
                                            hooks to share logic across multiple
                                            React components.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="w-full max-w-3xl gap-x-4 md:flex">
                                ...
                                <div className="flex gap-x-2 md:w-7/12">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="mt-2 hidden text-sm md:block">
                                            Learn how to build dynamic and
                                            interactive user interfaces with
                                            React and the D3.js data
                            ...
                            <div className="w-full max-w-3xl gap-x-4 md:flex">
                                ...
                                <div className="flex gap-x-2 md:w-7/12">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="mt-2 hidden text-sm md:block">
                                            Learn how to implement user
                                            authentication in Node.js
                                            applications using the Passport.js
                                            middleware.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-x-2 md:w-7/12">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="mt-2 hidden text-sm md:block">
                                            ...
                                            visualizations and dashboards using
                                ...
                                <div className="flex gap-x-2 md:w-7/12">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="mt-2 hidden text-sm md:block">
                                            ...
                                            applications using Socket.IO for
                            ...
                            <div className="w-full max-w-3xl gap-x-4 md:flex">
                                ...
                                <div className="flex gap-x-2 md:w-7/12">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="mt-2 hidden text-sm md:block">
                                            Learn how to create captivating
                            ...
                            <div className="w-full max-w-3xl gap-x-4 md:flex">
                                ...
                                <div className="flex gap-x-2 md:w-7/12">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="mt-2 hidden text-sm md:block">
                                            Explore advanced patterns and
                                            techniques for building scalable and
